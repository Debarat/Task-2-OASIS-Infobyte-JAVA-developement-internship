...
public class NumberGuessingGame {
        ...
        try {
            ...
            switch (menuOption) {
                case 1:
                    ...
                    int randomNum = methodChange.randomNum(NumRange);
                    methodChange.guessNumber(randomNum);
                    break;
                case 2:
    ...
    public int randomNum(int NumRange) {
        Random random = new Random();
        int randomNum = random.nextInt(NumRange) + 1;
        return randomNum;
    }

    public void guessNumber(int randomNum) {
        Scanner input = new Scanner(System.in);
        int userGuess;
        int guess = 0;
        do {
